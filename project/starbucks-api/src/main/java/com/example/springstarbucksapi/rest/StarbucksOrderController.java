...
public class StarbucksOrderController {
    ...
    /* Get the status of a Starbucks Order */
    @GetMapping("/order/status/{orderid}")
    Message getOrderStatus(@PathVariable long orderid) {
